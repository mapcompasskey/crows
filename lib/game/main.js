...
.defines(function(){
    ...
    GameStage = ig.Game.extend({
        ...
        loadLevel: function(data) {
            ...
            this.camera.offset.y.min = 0;
            this.camera.offset.y.max = 0;
            this.camera.offset.width = 0;
            this.camera.offset.height = 40;
            this.camera.getMinMax();
            
            // spawn tree
            ig.game.spawnEntity(EntityTree, (this.tileSize * 34), (this.tileSize * 29));
            
            // spawn player
            ig.game.spawnEntity(EntityPlayer, (this.tileSize * 5), (this.tileSize * 18));
    ...
    ig.main('#canvas', GameStage, 1, 300, 240, 3);
